...
// High-quality placeholder images for admin interface
const PLACEHOLDER_URLS = {
  product:
    "https://via.placeholder.com/400x400/f3f4f6/9ca3af?text=Product+Image",
  banner:
    "https://via.placeholder.com/1200x400/f3f4f6/9ca3af?text=Banner+Image",
  avatar:
    "https://via.placeholder.com/150x150/f3f4f6/9ca3af?text=User+Avatar",
  logo: "https://via.placeholder.com/200x100/f3f4f6/9ca3af?text=Logo",
  general:
    "https://via.placeholder.com/300x300/f3f4f6/9ca3af?text=Image+Not+Available",
};
...
const FALLBACK_PLACEHOLDER_URLS = {
  ...
  general:
    "https://images.unsplash.com/photo-1560472355-536de3962603?w=300&h=300&fit=crop",
};
