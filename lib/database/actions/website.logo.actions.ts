 ...
 */
export async function createWebsiteLogo(logoData: {
  name: string;
  logoUrl: string;
  altText: string;
  isActive?: boolean;
  ...
  try {
    ...
    return {
      ...
      logo: JSON.parse(JSON.stringify(newLogo)),
    };
  } catch (error: any) {
...
export async function updateWebsiteLogo(
  ...
  try {
    ...
    return {
      ...
      logo: JSON.parse(JSON.stringify(updatedLogo)),
    };
  } catch (error: any) {
...
export async function setLogoAsActive(id: string) {
  try {
    ...
    return {
      ...
      logo: JSON.parse(JSON.stringify(activatedLogo)),
    };
  } catch (error: any) {
